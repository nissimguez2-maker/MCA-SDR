...
2. Add two pre-screen questions to the qualification page: existing advance payments (daily or weekly), and approximate negative bank days in the last 90 days. High-risk answers drop the merchant to Tier 2 or Pause before document collection.
...
1. Self-reported data is unreliable. A merchant claiming $20k/month can show $9k deposits and two live MCA positions on actual statements. Confirm deposit range and stacking status before Tier 1 commitment.
